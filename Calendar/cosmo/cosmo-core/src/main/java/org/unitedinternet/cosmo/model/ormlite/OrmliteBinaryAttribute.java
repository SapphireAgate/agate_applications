...
public class OrmliteBinaryAttribute extends OrmliteAttribute implements BinaryAttribute {

    private static final long serialVersionUID = 6296196539997344427L;

    @DatabaseField(columnName = "attributetype", defaultValue = "boolean")
    ...
    /** default constructor */
    public OrmliteBinaryAttribute() {
    }

    public OrmliteBinaryAttribute(QName qname, byte[] value) {
        setQName(qname);
        this.value = value;
    }
     ...
     * @param value
     */
    public OrmliteBinaryAttribute(QName qname, InputStream value) {
        setQName(qname);
    ...
    public Attribute copy() {
        BinaryAttribute attr = new OrmliteBinaryAttribute();
