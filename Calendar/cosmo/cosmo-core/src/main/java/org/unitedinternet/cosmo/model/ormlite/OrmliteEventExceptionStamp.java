...
public class OrmliteEventExceptionStamp extends OrmliteBaseEventStamp implements EventExceptionStamp {
    ...
    /** default constructor */
    public OrmliteEventExceptionStamp() {
    }
    
    public OrmliteEventExceptionStamp(Item item) {
        setItem(item);
    }
    ...
    public EventStamp getMasterStamp() {
        ...
        return OrmliteEventStamp.getStamp(note.getModifies());
    }
     ...
     */
    public Stamp copy() {
        EventExceptionStamp stamp = new OrmliteEventExceptionStamp();
	...
	public void setItem(Item item) {
		// TODO Auto-generated method stub
		System.out.println("[AGATE] setItem not implemented OrmliteEventExceptionStamp");
	}
