 ...
 */
//@Embeddable
public class OrmliteEventTimeRangeIndex {
    ...
    @DatabaseField(columnName = "endate")
    private String endDate = null;
    
    //@Column(table="event_stamp", name = "isfloating")
    @DatabaseField(columnName = "isfloating")
    private Boolean isFloating = null;
    
    //@Column(table="event_stamp", name = "isrecurring")
    @DatabaseField(columnName = "isrecurring")
    private Boolean isRecurring = null;
    
    public OrmliteEventTimeRangeIndex() {}
    
    public OrmliteEventTimeRangeIndex(String startDate, String endDate, Boolean isFloating, Boolean isRecurring) {
