...
public class OrmliteCalendarAttributeWrapper extends OrmliteAttributeWrapper implements CalendarAttribute {

    private static final long serialVersionUID = 4409224462434581867L; 

    /** default constructor */
    public OrmliteCalendarAttributeWrapper() {
    	getPersistedAttribute().setAttributetype("calendar");
    }
     ...
     */
    public OrmliteCalendarAttributeWrapper(QName qname, Calendar value) {
        setQName(qname);
     ...
     */
    public OrmliteCalendarAttributeWrapper(QName qname, String value) {
        setQName(qname);
        setValue(value);
    }
    ...
    public Attribute copy() {
        CalendarAttribute attr = new OrmliteCalendarAttributeWrapper();
