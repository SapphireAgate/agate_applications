...
@DatabaseTable(tableName = "stamp")
public class OrmliteCalendarCollectionStamp extends OrmliteStamp implements ICalendarConstants, CalendarCollectionStamp {
    ...
    @DatabaseField(columnName = "stamptype", defaultValue = "calendar")
    private String stamptype;
    
    
    /** default constructor */
    public OrmliteCalendarCollectionStamp() {
    }
    ...
    public OrmliteCalendarCollectionStamp(CollectionItem collection) {
        this();
        setItem(collection);
    }

    public Stamp copy() {
        CalendarCollectionStamp stamp = new OrmliteCalendarCollectionStamp();
        return stamp;
    }
    ...
    public String getDescription() {
        ...
        return OrmliteStringAttribute.getValue(getItem(), ATTR_CALENDAR_DESCRIPTION);
    }
    ...
    public void setDescription(String description) {
        // description stored as StringAttribute on Item
        OrmliteStringAttribute.setValue(getItem(), ATTR_CALENDAR_DESCRIPTION, description);
    }
    ...
    public String getLanguage() {
        ...
        return OrmliteStringAttribute.getValue(getItem(), ATTR_CALENDAR_LANGUAGE);
    }
    ...
    public void setLanguage(String language) {
        // language stored as StringAttribute on Item
        OrmliteStringAttribute.setValue(getItem(), ATTR_CALENDAR_LANGUAGE, language);
    }
    ...
    public Calendar getTimezoneCalendar() {
        ...
        return OrmliteICalendarAttribute.getValue(getItem(), ATTR_CALENDAR_TIMEZONE);
    }
    
    @Override
    public void setTargetUri(String targetUri) {
        OrmliteStringAttribute.setValue(getItem(), ATTR_CALENDAR_TARGET_URI, targetUri);
    }
    
    @Override
    public String getTargetUri() {
        return OrmliteStringAttribute.getValue(getItem(), ATTR_CALENDAR_TARGET_URI);
    }
    ...
    public void setTimezoneCalendar(Calendar timezone) {
        ...
        OrmliteICalendarAttribute.setValue(getItem(), ATTR_CALENDAR_TIMEZONE, timezone);
    }
...
//    }
    ...
    public String getColor() {
        ...
        return OrmliteStringAttribute.getValue(getItem(), ATTR_CALENDAR_COLOR);
    }

    @Override
    public void setColor(String color) {
        // color stored as StringAttribute on Item
        OrmliteStringAttribute.setValue(getItem(), ATTR_CALENDAR_COLOR, color);
    ...
    public Boolean getVisibility() {
        ...
        return OrmliteBooleanAttribute.getValue(getItem(), ATTR_CALENDAR_VISIBILITY);
    }

    @Override
    public void setVisibility(Boolean visibility) {
        // color stored as BooleanAttribute on Item
        OrmliteBooleanAttribute.setValue(getItem(), ATTR_CALENDAR_VISIBILITY, visibility);
