...
public class OrmliteTextAttributeWrapper extends OrmliteAttributeWrapper implements TextAttribute {
     ...
     * @param reader
     */
    public OrmliteTextAttributeWrapper(QName qname, Reader reader) {
        setQName(qname);
        getPersistedAttribute().setTextvalue(read(reader));
    }
    ...
    public String getValue() {
        return getPersistedAttribute().getTextvalue();
    }
    ...
    public Attribute copy() {
        TextAttribute attr = new OrmliteTextAttributeWrapper();
    ...
    public static void setValue(Item item, QName qname, String value) {
        ...
        if(attr==null && value!=null) {
            attr = new OrmliteTextAttributeWrapper(qname,value);
