...
@DatabaseTable()
public class OrmliteDecimalAttribute extends OrmliteAttribute implements DecimalAttribute {

    private static final long serialVersionUID = 7830581788843520989L;
    
    @DatabaseField(columnName = "attributetype", defaultValue = "decimal")
    ...
    /** default constructor */
    public OrmliteDecimalAttribute() {
    }

    public OrmliteDecimalAttribute(QName qname, BigDecimal value) {
        setQName(qname);
        this.value = value;
    }
    ...
    public Attribute copy() {
        DecimalAttribute attr = new OrmliteDecimalAttribute();
