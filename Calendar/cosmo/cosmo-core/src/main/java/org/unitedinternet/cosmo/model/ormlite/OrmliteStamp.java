...
public class OrmliteStamp implements Stamp {//extends HibAuditableObject implements Stamp {

    private static final long serialVersionUID = 3717468937415626702L;
    // Fields
//    @ManyToOne(targetEntity=OrmliteItem.class, fetch = FetchType.EAGER)
...
//    }
	...
	public void setType(String stamptype) {
