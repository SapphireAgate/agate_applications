...
public class OrmliteMessageStamp extends OrmliteStamp implements MessageStamp {

    private static final long serialVersionUID = -6100568628972081120L;
    
    public static final QName ATTR_MESSAGE_ID = new OrmliteQName(
            MessageStamp.class, "messageId");
    
    public static final QName ATTR_MESSAGE_HEADERS = new OrmliteQName(
            MessageStamp.class, "headers");
    
    public static final QName ATTR_MESSAGE_FROM = new OrmliteQName(
            MessageStamp.class, "from");
    
    public static final QName ATTR_MESSAGE_TO = new OrmliteQName(
            MessageStamp.class, "to");
    
    public static final QName ATTR_MESSAGE_CC = new OrmliteQName(
            MessageStamp.class, "cc");
    
    public static final QName ATTR_MESSAGE_BCC = new OrmliteQName(
            MessageStamp.class, "bcc");
    
    public static final QName ATTR_MESSAGE_ORIGINATORS = new OrmliteQName(
            MessageStamp.class, "originators");
    
    public static final QName ATTR_MESSAGE_DATE_SENT = new OrmliteQName(
            MessageStamp.class, "dateSent");
    
    public static final QName ATTR_MESSAGE_IN_REPLY_TO = new OrmliteQName(
            MessageStamp.class, "inReplyTo");
    
    public static final QName ATTR_MESSAGE_REFERENCES = new OrmliteQName(
            MessageStamp.class, "references");
    
    @DatabaseField(columnName = "stamptype", defaultValue = "message")
    private String stamptype;
    
    /** default constructor */
    public OrmliteMessageStamp() {
    }
    
    public OrmliteMessageStamp(Item item) {
        setItem(item);
    }
    ...
    public String getMessageId() {
        ...
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_ID);
    }
    ...
    public void setMessageId(String id) {
        // id stored as StringAttribute on Item
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_ID, id);
        //updateTimestamp();
    }
    ...
    public String getHeaders() {
        ...
        return OrmliteTextAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_HEADERS);
    }
    ...
    public void setHeaders(String headers) {
        // headers stored as TextAttribute on Item
        OrmliteTextAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_HEADERS, headers);
        //updateTimestamp();
    }
    ...
    public String getFrom() {
        ...
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_FROM);
    }
    ...
    public void setFrom(String from) {
        // from stored as StringAttribute on Item
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_FROM, from);
        //updateTimestamp();
    }
    ...
    public String getTo() {
        ...
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_TO);
    }
    ...
    public void setTo(String to) {
        // to stored as StringAttribute on Item
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_TO, to);
        //updateTimestamp();
    }
    ...
    public String getBcc() {
        ...
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_BCC);
    }
    ...
    public void setBcc(String bcc) {
        //bcc stored as StringAttribute on Item
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_BCC, bcc);
        //updateTimestamp();
    }
    ...
    public String getCc() {
        ...
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_CC);
    }
    ...
    public void setCc(String cc) {
        // cc stored as StringAttribute on Item
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_CC, cc);
        //updateTimestamp();
    }
    ...
    public String getOriginators() {
        ...
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_ORIGINATORS);
    }
    ...
    public void setOriginators(String originators) {
        // originators stored as StringAttribute on Item
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_ORIGINATORS, originators);
        //updateTimestamp();
    }
    ...
    public String getDateSent() {
        ...
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_DATE_SENT);
    }
    ...
    public void setDateSent(String dateSent) {
        ...
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_DATE_SENT, dateSent);
        //updateTimestamp();
    }
    ...
    public String getInReplyTo() {
        // inReployTo stored as StringAttribute on Item
        return OrmliteStringAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_IN_REPLY_TO);
    }
    ...
    public void setInReplyTo(String inReplyTo) {
        // inReployTo stored as TextAttribute on Item
        OrmliteStringAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_IN_REPLY_TO, inReplyTo);
        //updateTimestamp();
    }
    ...
    public String getReferences() {
        ...
        return OrmliteTextAttributeWrapper.getValue(getItem(), ATTR_MESSAGE_REFERENCES);
    }
    ...
    public void setReferences(String references) {
        // references stored as TextAttribute on Item
        OrmliteTextAttributeWrapper.setValue(getItem(), ATTR_MESSAGE_REFERENCES, references);
        //updateTimestamp();
    }
    ...
    public Stamp copy() {
        MessageStamp stamp = new OrmliteMessageStamp();
        return stamp;
    }
