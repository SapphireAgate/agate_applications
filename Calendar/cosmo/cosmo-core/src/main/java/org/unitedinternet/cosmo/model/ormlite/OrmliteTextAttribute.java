...
public class OrmliteTextAttribute extends OrmliteAttribute implements TextAttribute {
    ...
    @DatabaseField(columnName = "attributetype", defaultValue = "text")
...
//    @Type(type="materialized_clob")
    ...
    /** default constructor */
    public OrmliteTextAttribute() {
    }

    public OrmliteTextAttribute(QName qname, String value) {
        setQName(qname);
        this.value = value;
    }
     ...
     * @param reader
     */
    public OrmliteTextAttribute(QName qname, Reader reader) {
        setQName(qname);
    ...
    public Attribute copy() {
        TextAttribute attr = new OrmliteTextAttribute();
    ...
    public static void setValue(Item item, QName qname, String value) {
        ...
        if(attr==null && value!=null) {
            attr = new OrmliteTextAttribute(qname,value);
