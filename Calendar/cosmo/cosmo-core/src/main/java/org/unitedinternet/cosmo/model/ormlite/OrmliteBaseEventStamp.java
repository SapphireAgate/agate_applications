...
public abstract class OrmliteBaseEventStamp extends OrmliteEventTimeRangeIndex implements ICalendarConstants, BaseEventStamp {
    ...
    //@NotNull
    @DatabaseField(columnName = "icaldata")
    private String eventCalendar = null;
    ...
    //@Embedded
    //private OrmliteEventTimeRangeIndex timeRangeIndex = null;
    ...
    public Calendar getEventCalendar() {
        return fromString(this.eventCalendar);
    }
    ...
    public void setEventCalendar(Calendar calendar) {
        this.eventCalendar = toString(calendar);
    }
    
    //public OrmliteEventTimeRangeIndex getTimeRangeIndex() {
    //    return timeRangeIndex;
    //}

    //public void setTimeRangeIndex(OrmliteEventTimeRangeIndex timeRangeIndex) {
