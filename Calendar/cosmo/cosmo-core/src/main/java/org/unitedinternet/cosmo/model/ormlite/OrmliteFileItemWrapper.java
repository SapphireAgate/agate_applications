...
public class OrmliteFileItemWrapper extends OrmliteContentItemWrapper implements FileItem {
    ...
    private OrmliteContentData contentData = null;

    public OrmliteFileItemWrapper() {
    	getPersistedItem().setItemtype("file");
    }
    ...
    public void setContent(InputStream is) throws IOException {
        if(contentData==null) {
            contentData = new OrmliteContentData(); 
        }
    ...
    public Item copy() {
        FileItem copy = new OrmliteFileItemWrapper();
        copyToItem(copy);
        return copy;
    }
