...
public class OrmliteBooleanAttribute extends OrmliteAttribute implements BooleanAttribute {
    ...
    /** default constructor */
    public OrmliteBooleanAttribute() {
    }

    public OrmliteBooleanAttribute(QName qname, Boolean value) {
        setQName(qname);
        this.value = value;
    }
    ...
    public Attribute copy() {
        BooleanAttribute attr = new OrmliteBooleanAttribute();
    ...
    public static void setValue(Item item, QName qname, Boolean value) {
        ...
        if(attr==null && value!=null) {
            attr = new OrmliteBooleanAttribute(qname,value);
