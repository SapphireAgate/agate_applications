...
public class OrmliteStringAttribute extends OrmliteAttribute implements  StringAttribute {

    public static final int VALUE_LEN_MAX = 2048;
    
    private static final long serialVersionUID = 2417093506524504993L;
    
    @DatabaseField(columnName = "attributetype", defaultValue = "string")
...
//    @Length(min=0, max=VALUE_LEN_MAX)
    ...
    /** default constructor */
    public OrmliteStringAttribute() {
    }

    public OrmliteStringAttribute(QName qname, String value) {
        setQName(qname);
        this.value = value;
    }
    ...
    public Attribute copy() {
        StringAttribute attr = new OrmliteStringAttribute();
    ...
    public static void setValue(Item item, QName qname, String value) {
        ...
        if(attr==null && value!=null) {
            attr = new OrmliteStringAttribute(qname,value);
