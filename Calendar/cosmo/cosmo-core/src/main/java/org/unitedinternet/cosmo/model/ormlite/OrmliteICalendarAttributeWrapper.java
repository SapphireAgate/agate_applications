...
public class OrmliteICalendarAttributeWrapper extends OrmliteAttributeWrapper implements ICalendarAttribute {
     ...
     */
    public OrmliteICalendarAttributeWrapper(QName qname, String value) {
        setQName(qname);
        setValue(value);
    }
    ...
    public Calendar getValue() {
        return fromString(getPersistedAttribute().getTextvalue());
    }
    ...
    public void setValue(String value) {
    	...
    	getPersistedAttribute().setTextvalue(value);
        //} catch (ParserException e) {
    ...
    public void setValue(InputStream is) {
        try {
        	getPersistedAttribute().setTextvalue(toString(CalendarUtils.parseCalendar(is)));
        } catch (ParserException e) {
    ...
    public Attribute copy() {
        ICalendarAttribute attr = new OrmliteICalendarAttributeWrapper();
        attr.setQName(getQName().copyQName());
        try {
            attr.setValue(fromString(getPersistedAttribute().getTextvalue()));
        } catch (Exception e) {
    ...
    public static void setValue(Item item, QName qname, Calendar value) {
        ...
        if(attr==null && value!=null) {
            attr = new OrmliteICalendarAttributeWrapper(qname,value);
