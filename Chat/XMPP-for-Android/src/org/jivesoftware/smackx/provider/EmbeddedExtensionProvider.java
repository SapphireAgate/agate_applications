...
/**
 * 
 * This class simplifies parsing of embedded elements by using the <a
 * href="http://en.wikipedia.org/wiki/Template_method_pattern">Template Method
 * Pattern</a>. After extracting the current element attributes and content of
 * any child elements, the template method (
 * {@link #createReturnExtension(String, String, Map, List)} is called.
 * Subclasses then override this method to create the specific return type.
 * 
 * <p>
 * To use this class, you simply register your subclasses as extension providers
 * in the <b>smack.properties</b> file. Then they will be automatically picked
 * up and used to parse any child elements.
 * 
 * <pre>
 ...
 * 
 * @deprecated This has been moved to
 *             {@link org.jivesoftware.smack.provider.EmbeddedExtensionProvider}
 */
@Deprecated
abstract public class EmbeddedExtensionProvider implements
		PacketExtensionProvider {

	abstract protected PacketExtension createReturnExtension(
			String currentElement, String currentNamespace,
	...
	final public PacketExtension parseExtension(XmlPullParser parser)
		...
		do {
			...
			if (tag == XmlPullParser.START_TAG) {
				extensions.add(PacketParserUtils.parsePacketExtension(
