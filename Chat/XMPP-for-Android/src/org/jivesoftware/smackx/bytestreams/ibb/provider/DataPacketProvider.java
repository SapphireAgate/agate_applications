...
public class DataPacketProvider implements PacketExtensionProvider, IQProvider {
	...
	public PacketExtension parseExtension(XmlPullParser parser)
			throws Exception {
		final String sessionID = parser.getAttributeValue("", "sid");
		final long seq = Long.parseLong(parser.getAttributeValue("", "seq"));
	...
	public IQ parseIQ(XmlPullParser parser) throws Exception {
		final DataPacketExtension data = (DataPacketExtension) parseExtension(parser);
		final IQ iq = new Data(data);
		return iq;
	}
