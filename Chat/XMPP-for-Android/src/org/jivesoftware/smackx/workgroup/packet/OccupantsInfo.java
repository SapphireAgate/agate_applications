...
/**
 * Packet used for requesting information about occupants of a room or for
 * retrieving information such information.
 * 
...
public class OccupantsInfo extends IQ {
	...
	public static class Provider implements IQProvider {
		...
		public IQ parseIQ(XmlPullParser parser) throws Exception {
			...
			final OccupantsInfo occupantsInfo = new OccupantsInfo(
					parser.getAttributeValue("", "roomID"));
		...
		private OccupantInfo parseOccupantInfo(XmlPullParser parser)
				throws Exception {
	...
	public OccupantsInfo(String roomID) {
		this.roomID = roomID;
		occupants = new HashSet<OccupantInfo>();
	}
	...
	public String getChildElementXML() {
		...
		synchronized (occupants) {
			for (final OccupantInfo occupant : occupants) {
				buf.append("<occupant>");
