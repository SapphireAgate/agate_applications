...
/**
 * IQ packet for retrieving the transcript search form, submiting the completed
 * search form or retrieving the answer of a transcript search.
 * 
...
public class TranscriptSearch extends IQ {
	...
	public static class Provider implements IQProvider {
		...
		public IQ parseIQ(XmlPullParser parser) throws Exception {
			final TranscriptSearch answer = new TranscriptSearch();
