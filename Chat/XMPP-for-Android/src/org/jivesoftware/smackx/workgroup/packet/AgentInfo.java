...
public class AgentInfo extends IQ {
	...
	public static class Provider implements IQProvider {
		...
		public IQ parseIQ(XmlPullParser parser) throws Exception {
			final AgentInfo answer = new AgentInfo();
	...
	/**
	 * Returns the Agent's name. The name of the agent may be different than the
	 * user's name. This property may be shown in the webchat client.
	 * 
	...
	/**
	 * Sets the Agent's name. The name of the agent may be different than the
	 * user's name. This property may be shown in the webchat client.
	 * 
	 * @param name
