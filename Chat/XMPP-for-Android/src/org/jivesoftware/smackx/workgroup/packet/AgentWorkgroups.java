...
/**
 * Represents a request for getting the jid of the workgroups where an agent can
 * work or could represent the result of such request which will contain the
 * list of workgroups JIDs where the agent can work.
 * 
...
public class AgentWorkgroups extends IQ {
	...
	public static class Provider implements IQProvider {
		...
		public IQ parseIQ(XmlPullParser parser) throws Exception {
			final String agentJID = parser.getAttributeValue("", "jid");
	...
	private final List<String> workgroups;

	/**
	 * Creates an AgentWorkgroups request for the given agent. This IQ will be
	 * sent and an answer will be received with the jid of the workgroups where
	 * the agent can work.
	 * 
	 * @param agentJID
	...
	/**
	 * Creates an AgentWorkgroups which will contain the JIDs of the workgroups
	 * where an agent can work.
	 * 
	 * @param agentJID
	 *            the id of the agent that can work in the list of workgroups.
	 * @param workgroups
	...
	public String getChildElementXML() {
		...
		buf.append(
				...
				.append(agentJID).append("\">");

		for (final String workgroupJID : workgroups) {
