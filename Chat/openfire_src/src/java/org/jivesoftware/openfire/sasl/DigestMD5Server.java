    ...
    private byte[] validateClientResponse(byte[][] responseVal)
        ...
        try {
            ...
            RealmCallback rcb = new RealmCallback("DIGEST-MD5 realm: ",
                negotiatedRealm);
            org.apache.harmony.javax.security.auth.callback.NameCallback ncb = new org.apache.harmony.javax.security.auth.callback.NameCallback("DIGEST-MD5 authentication ID: ",
                username);
