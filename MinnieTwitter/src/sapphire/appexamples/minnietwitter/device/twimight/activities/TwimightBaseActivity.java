...
import sapphire.appexamples.minnietwitter.device.twimight.util.LogCollector;
...
public class TwimightBaseActivity extends FragmentActivity{
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		case R.id.menu_my_profile:
			...
			//System.out.println("Querying for users; user = " + LoginActivity.getTwitterId());
			Cursor c = getContentResolver().query(uri, null, TwitterUsers.COL_SCREENNAME+"=\""+LoginActivity.getTwitterId() +"\"", null, null);
