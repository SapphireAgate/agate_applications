...
public class User implements SapphireObject {
	...
	public Tweet tweet(String text, String source, int photoId) {
		Tweet t = userTimeline.tweet(text, source, photoId);
		//System.out.println("@" + me.getUserInfo().getScreenName() + " tweeted: " + text);
		deliverTweet(t);
		return t;
	}
