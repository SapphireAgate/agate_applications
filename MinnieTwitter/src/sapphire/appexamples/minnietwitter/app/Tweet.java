...
public class Tweet implements Serializable {
	...
	private byte[] photo = null; // used only on the client side
	...
	public Tweet(String text, User author, String authorScreenName, int pos, Date createdAt, String source, int photoId) {
		this(text, author, authorScreenName, pos, createdAt, source);
